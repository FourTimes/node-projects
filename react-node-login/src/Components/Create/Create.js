...
const Create = ({ history: { push } }) => {
    ...
    const getTransactionDate= (event) =>{
   ...
   const onRedirect = () => {
    ...
    const fromSubmitValues = (event) => {
        if (clientname !== 'select' && clientname !== '' && amount !== '' && transactionDate !== '' ) {
        ...
        <Fragment>
            <Form className="_Create">
                <Form.Row>
                    ...
                    <Form.Group as={Col} md="2">
                        <Form.Label className="_createFont">transaction Date</Form.Label>                     
                        <Form.Control
                            type="date"
                            onChange={getTransactionDate}
                            name="date"
